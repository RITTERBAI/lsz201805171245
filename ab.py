...
adbt = AdaBoostClassifier(DecisionTreeClassifier(max_depth=5, min_samples_split=30, min_samples_leaf=5),
                          algorithm="SAMME", n_estimators=500, learning_rate=0.4)
...
plt.ylabel('Width（cm）')
plt.title('AdaBoost (n_e=500, l_r=0.4)',fontsize=20)
plt.legend()    # 添加标签
plt.show()
